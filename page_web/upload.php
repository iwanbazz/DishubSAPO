          ...
          <div class="col-sm-8 col-sm-offset-5 col-md-6 col-md-offset-3">
            <div class="page-login-form box">
              ...
              <form role="form" class="login-form" method="post" enctype="multipart/form-data">
               <input class="file" id="featured-file" name="file" type="file"></div>
                     
                  <span>Upload File Dalam Extensi ".JPG", atau "PDF"</span>
                
                <input class="btn btn-common log-btn" name="upload_data" type="submit" value="Kirim">
              </form>
            </div>
          </div>
        </div>
