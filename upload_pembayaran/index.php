<?php
  ...
  extract($_POST);
  include '../koneksi.php';
  if(!isset($_GET['page']) || !isset($_GET['idBerkas']) || empty($_SESSION['c58c1d179d60e7874f8c856f833eedd3-login'])){
    header("location:../");
  }else{
  ...
  if(isset($upload_data)){
    ...
    { 
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'], "../berkas_pembayaran/".$idBerkas."/". basename($nameFile))){
          if(mysqli_query($con,"update tbl_berkas set pembayaran='$nameFile' where id='$idBerkas'")){
            $ps="
              <div class='alert alert-success alert-dismissable' style='margin-top:20px'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
              <h4><i class='icon glyphicon glyphicon-remove'></i> Uploaded !</h4> Bukti Pembayaran berhasil diUpload.
              </div>
            ";
          }
        }
        ...
        $ps="
            ...
            <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
            <h4><i class='icon glyphicon glyphicon-remove'></i> Gagal !</h4> Bukti Pembayaran Anda gagal diUpload.
            </div>
        ";
    }
  }
...
<html lang="en">
  ...
  <body>  
    ...
    <?php
      if(isset($_GET['page'])){
        include'../page_web/upload_pembayaran.php';
      }
    ?>
    <!-- Content section End --> 
              ...
              <div class="widget">
                ...
                <ul class="featured-list">
                  ...
                  <li style="background:#ffc400">
                    ...
                    <div class="hover">
                      <a href="../register_trayek/?type=barang"><span style="margin-left:-25px;margin-top:-10px">Barang</span></a>
                    </div>
                  </li>
                </ul> 	 						
    					</div>
